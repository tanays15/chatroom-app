...
$(OBJ_DIR)/client: $(OBJ_DIR)/client.o $(OBJ_DIR)/util.o
	$(CC) $(CFLAGS) -o $(OBJ_DIR)/client $(SRC_DIR)/client.o $(OBJ_DIR)/util.o

$(OBJ_DIR)/client.o: $(SRC_DIR)/client.c $(SRC_DIR)/client.h $(SRC_DIR)/util.h
